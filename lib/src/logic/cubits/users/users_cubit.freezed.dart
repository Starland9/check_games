...
mixin _$UsersState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<AppUser> users) usersLoaded,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<AppUser> users)? usersLoaded,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _Loaded implements UsersState {
  const factory _Loaded(final AppUser user) = _$LoadedImpl;
...
class _$UsersLoadedImpl implements _UsersLoaded {
  const _$UsersLoadedImpl(final List<AppUser> users) : _users = users;
  ...
  @override
  String toString() {
    return 'UsersState.usersLoaded(users: $users)';
  }
...
abstract class _UsersLoaded implements UsersState {
  const factory _UsersLoaded(final List<AppUser> users) = _$UsersLoadedImpl;
